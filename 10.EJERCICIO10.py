...
nroPayasos = int(input('¿Cuantos payasos se han vendido? '))
nroMuñecas = int(input('¿Cuantas muñecas se han vendido? '))

final = ((pesoPayaso * nroPayasos)+(pesoMuñeca*nroMuñecas)) 

print ('El peso total del paquete es de ', final, ('g'))