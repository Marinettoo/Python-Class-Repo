...
respuesta = input('¿Quieres una pizza vegetariana? (Si/No) ').lower()

if respuesta == 'si':
    eleccion = input('Elige un ingrediente: Pimiento o Tofu ').capitalize()
    ingredientes = ['mozzarella', 'tomate', eleccion]
    tipo = 'Vegetariana'
else:
    eleccion = input('Elige un ingrediente: Peperoni, Jamón o Salmón ').capitalize()
    ingredientes = ['mozzarella', 'tomate', eleccion]
    tipo = 'No vegetariana'

print('Tu pizza es', tipo, 'y lleva:', ingredientes)
