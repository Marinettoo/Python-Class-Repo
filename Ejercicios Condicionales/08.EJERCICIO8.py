...
puntuacion = float(input('Introduce la puntutación obtenida: '))

if puntuacion == 0.0:
    print ('Tu rendimiento es Inaceptable')
    print ('Recibirás:', 2400*0.0, '€')

if puntuacion == 0.4:
    print ('Tu rendimiento es Aceptable')
    print ('Recibirás:', 2400*0.4, '€')
if puntuacion >= 0.6:
    print ('Tu rendimiento es Meritorio')
    print ('Recibirás:', 2400*puntuacion, '€')
